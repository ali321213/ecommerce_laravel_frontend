            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div
                    ...
                    <div
                        ...
                        <a wire:navigate
                            class="font-medium {{ request()->routeIs('categories.index') ? 'text-blue-600' : 'text-gray-500' }} hover:text-gray-400 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="{{ route('categories.index') }}">
                            Categories
                        </a>

                        <a wire:navigate
                            class="font-medium {{ request()->routeIs('products.index') ? 'text-blue-600' : 'text-gray-500' }} hover:text-gray-400 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                        ...
                        @auth
                            ...
                            <div class="hs-dropdown md:py-4">
                                <button type="button"
                                    class="flex items-center gap-2 font-medium text-gray-600 hover:text-gray-800 dark:text-gray-300">
                                    {{ auth()->user()->name }}
                                    <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div
                                    class="hs-dropdown-menu hidden opacity-0 transition-all duration-200 md:w-48 z-20 bg-white shadow-md rounded-lg p-2 dark:bg-gray-800">

                                    <a wire:navigate href="{{ route('orders.index') }}"
                                        class="block px-3 py-2 rounded-md text-sm hover:bg-gray-100 dark:hover:bg-gray-700">
                                        My Orders
                                    </a>
                                    ...
                                    <form method="POST" action="{{ route('logout') }}">
                                        @csrf
                                        <button type="submit"
                                            class="w-full text-left px-3 py-2 rounded-md text-sm text-red-600 hover:bg-red-50 dark:hover:bg-gray-700">
                                            Logout
                                        </button>
                                    </form>
                                </div>
